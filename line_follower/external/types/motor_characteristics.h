...
#ifndef LINE_FOLLOWER_EXTERNAL_TYPES_MOTOR_CHARACTERISTICS_H_
#define LINE_FOLLOWER_EXTERNAL_TYPES_MOTOR_CHARACTERISTICS_H_
...
#endif  // LINE_FOLLOWER_EXTERNAL_TYPES_MOTOR_CHARACTERISTICS_H_
